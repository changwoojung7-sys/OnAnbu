...
- **CARE** (`care.tsx`): 구글 애드몹 보상형 광고 시청 ➡️ 사진/동영상/음성 통합 미디어 무제한 마음 전송
- **HISTORY** (`two.tsx`): 부모님-자녀 간 **양방향 활동 로그** 타임라인 병합 및 사진/영상 구글 포토 스타일 카드 피드, 미디어 재생 지원
