...
const FAQ_DATA = [
    {
        q: '비밀번호를 잊어버렸어요.',
        a: '• 주/보조케어자: 로그인 화면 하단의 "비밀번호 찾기"를 통해 가입하신 이메일로 비밀번호 재설정 링크를 받으실 수 있습니다.\n\n• 케어대상(부모님): 이메일이 아닌 코드로 가입하셨기 때문에 앱 내에서 직접 비밀번호를 찾을 수 없습니다. 자녀분(주케어자)의 휴대폰 앱 내 [가족 관리] 화면에서 부모님 계정의 임시 비밀번호를 발급받아 새로 로그인해 주시기 바랍니다.'
    },
    {
        q: '회원탈퇴는 어떻게 하나요?',
